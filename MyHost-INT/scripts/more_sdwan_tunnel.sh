...
# GRE Tunnel Setup
/sbin/ip tunnel add $TUNNEL_NAME mode gre remote $REMOTE_ADDRESS local $LOCAL_ADDRESS ttl 255 key $TUNNEL_KEY
/sbin/ip link set $TUNNEL_NAME up
/sbin/ip link set dev $TUNNEL_NAME mtu 1400
